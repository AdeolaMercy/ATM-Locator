...
public class OldHomeScreen extends ActionBarActivity {
   ...
   /* ToggleButton toggle = (ToggleButton) findViewById(R.id.togglebutton);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        /*startActivity(new Intent(this,"com.atbtechsoft.adewumi.atmlocator.HomeScreen"));*/
      ...
      /*  int id = item.getItemId();
        ...
        /*switch(item.getItemId()) {
            case R.id.homemenu:
                Intent intent = new Intent(this, OldHomeScreen.class);
